...
class AdaptiveRootScaffold extends HookConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final destinations = [
      ...
      NavigationDestination(
        icon: const Icon(FluentIcons.data_funnel_20_filled),
        label: t.proxies.pageTitle,
      ),
      NavigationDestination(
        icon: const Icon(FluentIcons.save_edit_20_filled),
      ...
      NavigationDestination(
        icon: const Icon(FluentIcons.document_heart_20_filled),
...
class _CustomAdaptiveScaffold extends HookConsumerWidget {
  ...
  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final combinedDestinations = [
      ...destinationsSlice(bottomDestinationRange),
      ...destinationsSlice(drawerDestinationRange),
    ];
